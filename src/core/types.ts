...
export const DEFAULT_SETTINGS: PluginSettings = {
	...
	modules: [
		...
		{ id: 'weekly-reports', name: 'Weekly Reports', enabled: true, order: 3, collapsed: false },
		{ id: 'last-opened', name: 'Last Opened Documents', enabled: true, order: 4, collapsed: false },
		{ id: 'ai-dispatches', name: 'AI Dispatches', enabled: true, order: 5, collapsed: false },
	],
	quickAccessPaths: [],
